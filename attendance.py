...
message = tk.Label(window, text="FACIAL ATTENDANCE " ,bg="pink"  ,fg="black"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline')) 
...
lbl5.place(x=475-x_cord, y=375-y_cord)
...
def TrackImages():
    ...
    while True:
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.putText(im,str(tt),(x+5,y-5), font, 1,(255,255,255),1)   
            ##cv2.putText(im,str("{0}%".format(round(100-conf))),(x+5,y+h-5), font, 1,(255,255,255),2)       
...
takeImg.place(x=145-x_cord, y=425-y_cord)
...
trainImg.place(x=545-x_cord, y=425-y_cord)
trackImg = tk.Button(window, text="ATTENDANCE MARKING BUTTON", command=TrackImages  ,fg="white"  ,bg="green"  ,width=30  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
...
>>>>>>> 308d0d3897db3235515870913b4858b161c2fbbd
window.mainloop()